...
class _HomeViewState extends State<HomeView>
  ...
  //const String
  final String _firstTimeText = "Hadi şimdi Bob Ross ile yazıyı resme çevirin";
  ...
  Padding _buildResultImageList(BuildContext context, HomeViewModel viewModel) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          CustomLargeText(text: _resultsText, color: Colors.white),
          _buildSpacer(.03),
          SizedBox(
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            ...
            child: Padding(
              padding: context.paddingLow,
              child: GlassContainer(
                color: type.isSelected ? Colors.green : Colors.black,
                child: Container(
